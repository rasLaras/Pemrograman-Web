<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($email =="laras@gmail.com" && $password === "1234") {
            $_SESSION['login'] = $email;
            echo "<h1>Selamat, kamu berhasil login!</h1>";
            echo "<h2>Klik<a href ='gramedia2.php'> disini (gramedia2.php)</a> unutk menuju ke halaman pemeriksaan session</h2>";
                            ...
                            <div class="row gx-7 align-items-center">
                                <div class="card" style="width: 18rem;">
                                    <div class="card-body">
                                        ...
                                        <div class="d-grid">
                                            <button name="submit" style="background-color:rgb(41, 28, 160);font-size:small; font-weight:bold;" type="submit" class="btn rounded-pill text-light">MASUK</button>
                                        </div>
